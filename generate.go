...
func (f Function) BriefDoc() (brief string) { _ = "STUB: not implemented"; return "" }

func updateREADME() { _ = "STUB: not implemented"; return }

func tick(x int) string { _ = "STUB: not implemented"; return "" }

func getDoc(decls []ast.Decl) (doc string) { _ = "STUB: not implemented"; return "" }
